...
function tossHead() {
  ...
  if (z > 0.5) {
    alert(
      `You win the toss and your symbol is : ${String.fromCharCode(10004)}`
    );
...
function tossTail() {
  ...
  if (z > 0.5) {
    ...
    alert(
      `You loss the toss and your symbol is : ${String.fromCharCode(10004)}`
    );
    userTurnSymbol = String.fromCharCode(10004);
    autoTurnSymbol = "X";
  }
...
function checkFillBox() {
  if (
    document.querySelector(`.box${autoTurn}`).innerHTML == "1" ||
    document.querySelector(`.box${autoTurn}`).innerHTML == "2" ||
    document.querySelector(`.box${autoTurn}`).innerHTML == "3" ||
    document.querySelector(`.box${autoTurn}`).innerHTML == "4" ||
    document.querySelector(`.box${autoTurn}`).innerHTML == "5" ||
    document.querySelector(`.box${autoTurn}`).innerHTML == "6" ||
    document.querySelector(`.box${autoTurn}`).innerHTML == "7" ||
    document.querySelector(`.box${autoTurn}`).innerHTML == "8" ||
    document.querySelector(`.box${autoTurn}`).innerHTML == "9"
  ) {
